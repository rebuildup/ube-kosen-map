...
export const UnifiedCard = React.memo(
  ({
    ...
    const placeholderImage = useMemo(() => {
      switch (item.type) {
        case "event": return "./images/placeholder-event.jpg";
        case "exhibit": return "./images/placeholder-exhibit.jpg";
        case "stall": return "./images/placeholder-stall.jpg";
        case "sponsor": return "./images/placeholder-sponsor.jpg";
    ...
    const organization = useMemo(() => {
      switch (item.type) {
        case "event": return item.organizer;
        case "exhibit": return item.creator;
        case "stall": return item.products?.length > 0 ? item.products.join(", ") : "";
        default: return "";
      }
    }, [item]);
    ...
    const organizationLabel = useMemo(() => {
      switch (item.type) {
        case "event": return t("detail.organizer");
        case "exhibit": return t("detail.creator");
        case "stall": return t("detail.products");
        default: return "";
      }
    }, [item.type, t]);
    ...
    const cardContent = (
      <article
        className={`card cursor-pointer overflow-hidden rounded-xl transition-all duration-300 ${className}`}
