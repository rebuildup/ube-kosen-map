...
ube-kosen-map の current release-driven development で使用する Operating Model を定義します。
...
- GitHub Issues / Pull Requests を durable implementation / review surface とする
...
- existing Vite/React/TypeScript configuration remains application toolchain authority.
- Bun in mise is auxiliary for Agent Skills only unless separately adopted for app package management.
- map/content data correctness, source build/typecheck, and browser rendering/interactions are separate evidence scopes.

## Agent Skills lifecycle

- bootstrap: `mise run skills-bootstrap`.
- update: `mise run skills-update` / `bunx skills update -p -y`.
